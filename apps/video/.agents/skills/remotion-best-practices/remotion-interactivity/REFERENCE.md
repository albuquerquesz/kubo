...
<Interactive.Div name="Title">Remotion Best Practices</Interactive.Div>
```
...
<>
  ...
  <Sequence name="Title">Launch day</Sequence>
</>
```
...
<Composition
  ...
  } // ❌ Don't have type assertions, instead type MyComponent correctly
/>;
```
