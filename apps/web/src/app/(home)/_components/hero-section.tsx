  ...
  return (
    <section
      ...
      /* -mt-12 cancels layout.tsx pt-12 so artwork is full-bleed behind the fixed header.
         .hero-section.hero-short-viewport CSS tightens short landscape phones. */
      className="hero-section hero-short-viewport relative isolate -mt-12 min-h-svh overflow-hidden bg-background"
    >
      <MosaicHeroCanvas />
      ...
      <div
        className={cn(
          "hero-section-content relative z-10 flex min-h-svh w-full flex-col",
      ...
      >
        <div className="hero-section-stack flex w-full max-w-[40rem] flex-col items-start">
          <HeroDisplayTitle
            title="Construa sem começar do zero."
            className={cn(
              "hero-section-title max-w-[18ch] text-foreground",
          ...
          <p
            className={cn(
              "hero-section-copy mt-5 max-w-[36rem] text-pretty text-[1.125rem] leading-7 text-muted-foreground",
          ...
          <div className="hero-section-rail mt-8 w-fit max-w-full sm:mt-10">
            <HeroRailLower />
          </div>
        </div>
      </div>
