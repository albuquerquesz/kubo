...
- Raw JSON snapshot: `https://r2.kubojs.dev/analytics-data.json`
- CSV export: `https://r2.kubojs.dev/export.csv`
...
- CLI event sender: [`apps/cli/src/utils/analytics.ts`](https://github.com/albuquerquesz/kubo/blob/main/apps/cli/src/utils/analytics.ts)
- Telemetry toggle logic: [`apps/cli/src/utils/telemetry.ts`](https://github.com/albuquerquesz/kubo/blob/main/apps/cli/src/utils/telemetry.ts)
- Ingest endpoint: [`packages/backend/convex/http.ts`](https://github.com/albuquerquesz/kubo/blob/main/packages/backend/convex/http.ts)
- Analytics backend (ingest + aggregation): [`packages/backend/convex/analytics.ts`](https://github.com/albuquerquesz/kubo/blob/main/packages/backend/convex/analytics.ts)
