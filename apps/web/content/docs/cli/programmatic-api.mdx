...
description: Use kubojs programmatically in your Node.js applications
---

## Overview

You can call kubojs directly from TypeScript/JavaScript without shelling out to the CLI.

The programmatic API is exported from `kubojs` and is designed for automation tools, internal generators, and scripted workflows.
