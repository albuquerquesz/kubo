...
description: Learn how to self-host your kubojs app with the generated Dockerfiles and docker-compose.yml
author:
  name: Aman Varshney
...
This guide explains how kubojs packages your applications for self-hosting with [Docker Compose](https://docs.docker.com/compose/). You'll learn:
